...
Begin VB.Form frmLtdEv 
   ...
   Begin VB.ComboBox cmbPurpose 
      Height          =   315
      ItemData        =   "frmLtdEv.frx":164A
      Left            =   2040
      List            =   "frmLtdEv.frx":1654
      TabIndex        =   2
      Text            =   "Please Select"
      Top             =   1560
      Width           =   2175
   ...
   Begin VB.Frame FrameLarge 
      ...
      Begin VB.ComboBox cmbInfluence 
         Height          =   315
         ItemData        =   "frmLtdEv.frx":1674
         Left            =   1920
         List            =   "frmLtdEv.frx":1681
         TabIndex        =   11
         Text            =   "Please Select"
         Top             =   4320
         Width           =   2295
      ...
      Begin VB.ComboBox cmbSecurity 
         Height          =   315
         ItemData        =   "frmLtdEv.frx":16B8
         Left            =   1920
         List            =   "frmLtdEv.frx":16D4
         TabIndex        =   10
         Text            =   "Please Select"
         Top             =   3960
         Width           =   3015
      ...
      Begin VB.ComboBox cmbCharacter 
         Height          =   315
         ItemData        =   "frmLtdEv.frx":17A2
         Left            =   1920
         List            =   "frmLtdEv.frx":17AF
         TabIndex        =   9
         Text            =   "Please Select"
         Top             =   3600
         Width           =   3255
      ...
      Begin VB.ComboBox cmbRepayment 
         Height          =   315
         ItemData        =   "frmLtdEv.frx":17F0
         Left            =   1920
         List            =   "frmLtdEv.frx":17FA
         TabIndex        =   7
         Text            =   "Please Select"
         Top             =   2880
         Width           =   2535
      ...
      Begin VB.ComboBox cmbExchange 
         Enabled         =   0   'False
         Height          =   315
         ItemData        =   "frmLtdEv.frx":1824
         Left            =   1920
         List            =   "frmLtdEv.frx":182E
         TabIndex        =   6
         Text            =   "Please Select"
         Top             =   2520
         Width           =   1935
      ...
      Begin VB.Label lblHeading 
         Caption         =   "Limited Company Evaluation"
         BeginProperty Font 
            Name            =   "Times New Roman"
            Size            =   18
            Charset         =   0
...
ElseIf Trim(cmbRepayment.Text) = "Bussiness" And Val(txtIncome.Text) < 50000 Then
basGlobal.Result = "Rejected"
...
ElseIf Trim(Val(txtIncome.Text)) < 50000 And Trim(cmbInfluence.Text) = "Highly Influential" Then
basGlobal.Result = "Rejected"
basGlobal.Comment = " Capacity of the borrower is poor "
lblResult2.Caption = basGlobal.Result
lblReason2.Caption = basGlobal.Comment
...
ElseIf Val(txtIncome.Text) < 50000 Then
basGlobal.Result = "Rejected"
