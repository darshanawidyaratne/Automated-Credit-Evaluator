...
Begin VB.Form frmLease 
   ...
   Begin VB.CommandButton cmdClear 
      ...
      Width           =   1332
   End
   Begin VB.TextBox txtGrossRental 
      Enabled         =   0   'False
      Height          =   372
      Left            =   2040
      TabIndex        =   15
   ...
   Begin VB.TextBox txtLeaseAmount 
      ...
      Width           =   1452
   End
   Begin VB.Label lblGrossRental 
      Caption         =   "Gross Rental"
      BeginProperty Font 
...
Private Sub calculation()
    ...
    txtVAT.Visible = True
    txtGrossRental.Visible = True
    lblRental.Visible = True
    lblVAT.Visible = True
    lblGrossRental.Visible = True
    
    txtRental.Text = Str(Rental)
    txtVAT.Text = Str(VAT)
    txtGrossRental.Text = Str(grossRental)
