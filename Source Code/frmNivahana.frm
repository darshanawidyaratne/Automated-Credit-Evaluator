VERSION 5.00
Begin VB.Form frmNivahana 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Nivahana Loan Installement Computation "
   ClientHeight    =   3795
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6255
   FillColor       =   &H00FFFFFF&
   Icon            =   "frmNivahana.frx":0000
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   ScaleHeight     =   3795
...
Private Sub calculation()
    ...
    Instalment = ((LoanAmount * rate) / (((1 + rate) ^ Period) - 1)) + (LoanAmount * rate)
    txtInstalment.Text = Val(Instalment)
